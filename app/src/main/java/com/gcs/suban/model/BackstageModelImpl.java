...
public class BackstageModelImpl implements BackstageModel {
	private Context context = app.getContext();
	private BackstageBean bean;
	private Gson gson;

	@Override
	public void getInfo(String url, final OnBackstageListener listener) {
