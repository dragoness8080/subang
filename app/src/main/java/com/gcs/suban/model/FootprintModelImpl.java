...
public class FootprintModelImpl implements CollectModel{
	private Context context = app.getContext();
	private List<CollectBean> mListType;
	private String page = null;
	
	@Override
	public void getInfo(String url, String mPage, final OnCollectListener listener) {
	...
	@Override
	public void cancel(String url, String history_id, final OnCollectListener listener) {
		// TODO Auto-generated method stub
		final String TAG = url+history_id;
		// TODO Auto-generated method stub
		Map<String, String> params = new HashMap<String, String>();
		params.put("history_id", history_id);
		params.put("openid", MyDate.getMyVid());
		Log.e(TAG, history_id+" "+ MyDate.getMyVid());
		BaseVolleyRequest.StringRequestPost(context, url, TAG, params,
				new BaseStrVolleyInterFace(context,
						BaseStrVolleyInterFace.mListener,
						BaseStrVolleyInterFace.mErrorListener) {
