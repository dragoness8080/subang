...
OnBaseListener {
	...
	protected void init() {
		...
		Et_name.setText(bundle.getString("realname"));
		Et_tel.setText(bundle.getString("mobile"));
		Et_address.setText(bundle.getString("address"));
		Tv_province.setText(bundle.getString("province") + " "
				+ bundle.getString("city") + " " + bundle.getString("area"));
		province=bundle.getString("province");
		city=bundle.getString("city");
		area=bundle.getString("area");
		id = bundle.getString("addressid");
