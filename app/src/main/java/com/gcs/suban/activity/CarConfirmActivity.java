...
import com.gcs.suban.model.ConfirmCarModelImpl;
...
public class CarConfirmActivity extends BaseActivity implements
		OnConfirmListener {
	...
	public void onClick(View v) {
		...
		case R.id.btn_confirm:
			...
			orderBean.cartid = cartid;
			orderBean.remark = remark;
			orderBean.coupondataid = coupondataid;
			dialog.show();
			Btn_confirm.setClickable(false);
			model.confirm(Url.confirmcar, orderBean, this);
			break;
	...
	protected void init() {
		...
		model = new ConfirmCarModelImpl();
		model.getInfo(Url.cartaccount, orderBean, this);
