...
import com.gcs.suban.model.FootprintModelImpl;
...
public class FootprintActivity extends BaseActivity implements
	...
	protected void init() {
		...
		Btn_confirm= (Button) context.findViewById(R.id.layout_foot)
		...
		layout = (LinearLayout) context.findViewById(R.id.layout_null_foot);

		listView = (LoadListView) findViewById(R.id.list_footprint);
		...
		swipeRefreshLayout = (SwipeRefreshLayout) context
				.findViewById(R.id.swipeRefreshLayout_footprint);
		swipeRefreshLayout.setOnRefreshListener(this);
		InitSwipeRefreshLayout();

		model = new FootprintModelImpl();
		model.getInfo(Url.footprintlist, page, this);
	}
	...
	private void deleteShop() {
		...
		model.cancel(Url.cancelfootprintt, sb + "", this);
		}
	}
	...
	public void onEventMainThread(CollectEvent event) {
		...
		if (event.getType().equals("delete")) {
			model.cancel(Url.cancelfootprintt, msg, this);
