 ...
 * 余额明细
 */
public class BalanceRecordActivity extends BaseActivity implements
OnRecordListener, onLoadListViewListener, OnRefreshListener{
	...
	protected void init() {
		...
		Btn_confirm= (Button) context.findViewById(R.id.layout_balance)
				.findViewById(R.id.btn_confirm);
		Btn_confirm.setOnClickListener(this);
		
		layout = (LinearLayout) context.findViewById(R.id.layout_null_balance);
	...
	public void onRefresh() {
		...
		page = "0";
		isRefresh = true;
		model.getInfo(Url.record, page, this);
	}
