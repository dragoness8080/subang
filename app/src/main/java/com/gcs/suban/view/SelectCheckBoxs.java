...
public class SelectCheckBoxs extends LinearLayout {
	...
	public interface OnSelectListener {
		void onSelect(int i, int j,int p);
	}

	@SuppressWarnings("deprecation")
	public SelectCheckBoxs(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public SelectCheckBoxs(Context context) {
		super(context);
	}
	 ...
	 * @param data  
	 */
	public void setData(int i,Map<Integer, String> data) {
		this.i = i;//  代表在父listview中的行数
		this.mData = data;
		initView();
	}
	...
	private class OnChkClickEvent implements OnClickListener {
		...
		public void onClick(View v) {
			...
			mOnSelectListener.onSelect(i,j,mSelectPosition);
		}
	}
