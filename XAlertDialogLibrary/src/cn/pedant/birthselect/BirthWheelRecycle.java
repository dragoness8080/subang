 ...
 */
public class BirthWheelRecycle {
	// Cached items
	...
	// Wheel view
	private BirthWheelView wheel;
	
	/**
	 * Constructor
	 * @param wheel the wheel view
	 */
	public BirthWheelRecycle(BirthWheelView wheel) {
		this.wheel = wheel;
	}
	 ...
	 */
	public int recycleItems(LinearLayout layout, int firstItem, BirthItemsRange range) {
		int index = firstItem;
